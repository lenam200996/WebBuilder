<template>
  <div class="about container-fluid">
    <section-render  v-for="section in getElements.filter( item => item.type === 'section')"  :key="section.id" :styleSec="section.style">
          <column-render v-for="col in section.layout" :key="col.index" :columnIndex="col.index"   :size="col.size" :bgImg="col.bg">
